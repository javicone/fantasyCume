...
public class rellenarBBDD {
    ...
    // ==================== TEST SIMULACIÓN LIGA COMPLETA ====================
    @Test
    public void testSimulacionLigaCompleta() {
        System.out.println("\n╔═══════════════════════════════════════════════════════════════╗");
        System.out.println("║          TEST: SIMULACIÓN COMPLETA DE LIGA                    ║");
        System.out.println("╚═══════════════════════════════════════════════════════════════╝\n");
        ...
        usuario1.setNombreUsuario("Ibai Llanos");
        usuario1.setEmail("ibai@fantasy.com");
        usuario1.setPassword("pass123");
        usuario1.setPuntosAcumulados(0);
        usuario1.setLiga(liga);
        usuario1 = usuarioRepository.save(usuario1);
        System.out.println("✓ Usuario 1: " + usuario1.getNombreUsuario());

        Usuario usuario2 = new Usuario();
        usuario2.setNombreUsuario("ElRubius");
        usuario2.setEmail("rubius@fantasy.com");
        usuario2.setPassword("pass123");
        usuario2.setPuntosAcumulados(0);
        usuario2.setLiga(liga);
        usuario2 = usuarioRepository.save(usuario2);
        System.out.println("✓ Usuario 2: " + usuario2.getNombreUsuario());

        Usuario usuario3 = new Usuario();
        usuario3.setNombreUsuario("DJMaRiiO");
        usuario3.setEmail("djmario@fantasy.com");
        usuario3.setPassword("pass123");
        usuario3.setPuntosAcumulados(0);
        usuario3.setLiga(liga);
        usuario3 = usuarioRepository.save(usuario3);
        System.out.println("✓ Usuario 3: " + usuario3.getNombreUsuario() + "\n");
        ...
        crearEstadistica(rm1, partido1J1, 0, 0, 0, false, true, 1, 3);  // Courtois - Portero
        crearEstadistica(rm2, partido1J1, 1, 1, 0, false, true, 0, 12); // Vinicius - Gol + Asistencia
        crearEstadistica(rm3, partido1J1, 1, 0, 0, false, true, 0, 7);  // Bellingham - Gol
        crearEstadistica(fcb1, partido1J1, 0, 0, 0, false, true, 2, 1); // Ter Stegen - 2 goles recibidos
        crearEstadistica(fcb2, partido1J1, 1, 0, 1, false, true, 0, 5); // Lewandowski - Gol + amarilla
        crearEstadistica(fcb3, partido1J1, 0, 1, 0, false, true, 0, 5); // Gavi - Asistencia
        ...
        crearEstadistica(atm1, partido2J1, 0, 0, 0, false, true, 0, 8);  // Oblak - Portería a cero
        crearEstadistica(atm2, partido2J1, 2, 0, 0, false, true, 0, 14); // Griezmann - 2 goles
        crearEstadistica(atm3, partido2J1, 1, 2, 0, false, true, 0, 12); // Morata - Gol + 2 asistencias
        crearEstadistica(sev1, partido2J1, 0, 0, 0, false, true, 3, -2); // Bounou - 3 goles recibidos
        crearEstadistica(sev2, partido2J1, 0, 0, 1, false, true, 0, 1);  // Ocampos - Amarilla
        System.out.println("  ✓ Estadísticas registradas\n");

        // Crear alineaciones para Jornada 1
        System.out.println("📝 Creando alineaciones para Jornada 1...");
        Alineacion alin1J1 = crearAlineacionJornada1(usuario1, jornada1, rm1, rm2, fcb2, atm2, atm3);
        Alineacion alin2J1 = crearAlineacionJornada1(usuario2, jornada1, atm1, rm3, fcb3, atm2, sev2);
        Alineacion alin3J1 = crearAlineacionJornada1(usuario3, jornada1, fcb1, rm2, atm3, fcb2, sev2);
        ...
        // Estadísticas Partido 1
        crearEstadistica(fcb1, partido1J2, 0, 0, 0, false, true, 1, 3);  // Ter Stegen
        crearEstadistica(fcb2, partido1J2, 1, 0, 0, false, true, 0, 7);  // Lewandowski - Gol
        crearEstadistica(fcb4, partido1J2, 0, 1, 0, false, true, 0, 5);  // Pedri - Asistencia
        crearEstadistica(atm1, partido1J2, 0, 0, 0, false, true, 1, 3);  // Oblak
        crearEstadistica(atm2, partido1J2, 1, 0, 0, false, true, 0, 7);  // Griezmann - Gol
        crearEstadistica(atm4, partido1J2, 0, 1, 1, false, true, 0, 3);  // Koke - Asistencia + amarilla
        System.out.println("  ✓ Estadísticas registradas\n");
        ...
        // Estadísticas Partido 2
        crearEstadistica(sev1, partido2J2, 0, 0, 0, false, true, 4, -3); // Bounou - 4 goles recibidos
        crearEstadistica(sev3, partido2J2, 0, 0, 0, false, false, 0, -1); // En-Nesyri - No jugó 60 min
        crearEstadistica(rm1, partido2J2, 0, 0, 0, false, true, 0, 8);   // Courtois - Portería a cero
        crearEstadistica(rm2, partido2J2, 2, 1, 0, false, true, 0, 17);  // Vinicius - 2 goles + asistencia
        crearEstadistica(rm4, partido2J2, 1, 1, 0, false, true, 0, 12);  // Rodrygo - Gol + asistencia
        crearEstadistica(rm5, partido2J2, 1, 0, 0, false, true, 0, 7);   // Valverde - Gol
        System.out.println("  ✓ Estadísticas registradas\n");

        // Crear alineaciones para Jornada 2
        System.out.println("📝 Creando alineaciones para Jornada 2...");
        Alineacion alin1J2 = crearAlineacionJornada2(usuario1, jornada2, rm1, rm2, rm4, fcb2, atm2);
        Alineacion alin2J2 = crearAlineacionJornada2(usuario2, jornada2, fcb1, rm2, rm5, fcb4, atm4);
        Alineacion alin3J2 = crearAlineacionJornada2(usuario3, jornada2, atm1, rm4, fcb2, sev3, atm2);
        System.out.println("✓ Alineaciones creadas\n");
        ...
        // Verificaciones
        assertEquals(3, usuarioRepository.findAll().size(), "Debe haber 3 usuarios");
        assertEquals(4, equipoRepository.findAll().size(), "Debe haber 4 equipos");
        assertEquals(20, jugadorRepository.findAll().size(), "Debe haber 20 jugadores");
        assertEquals(2, jornadaRepository.findAll().size(), "Debe haber 2 jornadas");
        assertEquals(4, partidoRepository.findAll().size(), "Debe haber 4 partidos");
        assertTrue(alineacionRepository.findAll().size() >= 6, "Debe haber al menos 6 alineaciones");
        assertTrue(estadisticaRepository.findAll().size() >= 22, "Debe haber al menos 22 estadísticas");
    }
    ...
    private Alineacion crearAlineacionJornada1(Usuario usuario, Jornada jornada, Jugador j1, Jugador j2,
    ...
    private Alineacion crearAlineacionJornada2(Usuario usuario, Jornada jornada, Jugador j1, Jugador j2,
                                               Jugador j3, Jugador j4, Jugador j5) {
        return crearAlineacionJornada1(usuario, jornada, j1, j2, j3, j4, j5);
    }
